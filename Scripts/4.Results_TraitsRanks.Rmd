...
for( i in 1:6){
  ...
  Three_Taus%>%
    ...
    ggplot( aes(D19_Tau))+
    geom_segment( x=0, xend = 0, y = -0.2, yend = 0.9,
                  col = 'grey60' , size = 0.5)+
        geom_segment( x=stats$Mean_Tau, xend = stats$Mean_Tau,
                      y = -0.18, yend = 0.9,# -0.02,
                  linetype = 'solid', col = 'red' , size = 1.5)+
...
ggsave('../Plots/Figure2.pdf', DotPlots,width = 10, height = 6)
ggsave('../Plots/Figure2.png', DotPlots,width = 10, height = 6)
...
ggsave( '../Plots/ExFigures/Terry_ED_2.jpg', CrossTrans_CorInSlopes,
        height = 2.5, width = 5, dpi = 500,scale =2  )
...
ggsave( '../Plots/ExFigures/Terry_ED_3.jpg', ComparisonDotplots, height = 6, width = 10, dpi = 500)
...
ggsave('../Plots/ExFigures/Terry_ED_4.jpg', TauPredictorsPlotA, width = 14, height =11, dpi = 500)
ggsave('../Plots/ExFigures/Terry_ED_5.jpg', TauPredictorsPlotB, width = 14, height =11, dpi = 500)
...
# Study-level Results - Extened Data Figure 1
...
ggsave('../Plots/ExFigures/Terry_ED_1.jpg',
...
ggsave( '../Plots/Figure1.pdf',plot = Map3, width = 7, height = 7, device = cairo_pdf)                     
```
...
ggsave( '../Plots/ExFigures/Terry_ED_6.jpg' ,SpeciesLevelPlots, width = 8, height =6, dpi = 500)
...
read_csv('../Results/Study_Corr_Predictors.csv')%>%
  ...
  select('Trait tested' = Trait,
         ...
         CENT_LAT,CENT_LONG,ABUNDANCE_TYPE,BIOMASS_TYPE  ) %>%
  write_csv('../SIdata/SuppData1.csv')
