...
### Overall (trait level) Quantilie boundaries
...
AllThree_All_cut %>%
  select( `Transformation A` = D19_slope,
          `Transformation B` = Slope,
          `Transformation C` = Elas_slope)-> Data4Corr
...
## Comparision of study-level distribution
...
Calaculation of statistics covering the scope of the final data used. NB 

Before the new tighter filtering procedure:
